...
class NxiwWidgetProvider : AppWidgetProvider() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        val ids = manager.getAppWidgetIds(ComponentName(context, NxiwWidgetProvider::class.java))
        for (id in ids) {
    ...
    private fun updateWidget(context: Context, manager: AppWidgetManager, id: Int) {
        val views = RemoteViews(context.packageName, R.layout.nxiw_widget)
        ...
        // Назначаем клик
        val intent = Intent(context, NxiwWidgetProvider::class.java).apply { action = "TOGGLE_VPN" }
