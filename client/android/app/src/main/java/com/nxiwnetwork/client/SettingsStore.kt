...
class SettingsStore(context: Context) {
    ...
    val suppressBatteryOptimizationPrompt: Flow<Boolean> = dataStore.data.map { it[SUPPRESS_BATTERY_OPTIMIZATION_PROMPT] ?: false }
    ...
    suspend fun saveSuppressBatteryOptimizationPrompt(enabled: Boolean) { dataStore.edit { prefs -> prefs[SUPPRESS_BATTERY_OPTIMIZATION_PROMPT] = enabled } }
